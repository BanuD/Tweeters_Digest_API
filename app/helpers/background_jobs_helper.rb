  ...
  def self.tweets_for_all_users
    ...
    all_users.each do |user|
      ...
      all_gatherings.each do |gathering|
        ...
        tweets.each { |tweet| Tweet.create(gathering_id: gathering.id, content: tweet.text, tweet_id: tweet.id, handle: leader.handle, url: tweet.url.to_s, leader_pic_url: leader.profile_image_url_https, tweet_creation_time: tweet.created_at) }
