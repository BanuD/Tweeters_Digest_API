# Collector.create(user_id: 1, leader_id: 6, query: "more")
...
# Tweet.create(content: "one", collector_id: 1)
# Tweet.create(content: "two", collector_id: 1)
# Tweet.create(content: "three", collector_id: 2)
# Tweet.create(content: "four", collector_id: 2)
